...
class __TwigTemplate_7a0d765480bb72abfd0076b9ad94eea9f58cfc128adc02466e46150a83ce83ec extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["categorium"]) {
            ...
            echo "            <tr>
                <td>";
            // line 19
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["categorium"], "id", [], "any", false, false, false, 19), "html", null, true);
            echo "</td>
                <td>";
            // line 20
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["categorium"], "name", [], "any", false, false, false, 20), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("categoria_show", ["id" => twig_get_attribute($this->env, $this->source, $context["categorium"], "id", [], "any", false, false, false, 22)]), "html", null, true);
            echo "\">Ver</a>
                    <a href=\"";
            // line 23
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("categoria_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["categorium"], "id", [], "any", false, false, false, 23)]), "html", null, true);
            echo "\">Editar</a>
                </td>
            </tr>
        ";
        ...
        if (!$context['_iterated']) {
            // line 27
            echo "            <tr>
                <td colspan=\"3\">Nose encontraron datos</td>
            </tr>
        ";
        }
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        {% for categorium in categorias %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path('categoria_show', {'id': categorium.id}) }}\">Ver</a>
                    <a href=\"{{ path('categoria_edit', {'id': categorium.id}) }}\">Editar</a>
                </td>
            </tr>
        {% else %}
            <tr>
    ...
    <a href=\"{{ path('categoria_new') }}\">Crear</a>
{% endblock %}
", "categoria/index.html.twig", "C:\\Users\\JMPAZ\\Documents\\todolistapp\\templates\\categoria\\index.html.twig");
    }
}
