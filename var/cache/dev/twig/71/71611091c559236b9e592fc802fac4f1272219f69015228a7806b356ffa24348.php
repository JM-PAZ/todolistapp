...
class __TwigTemplate_cb5e9f657cbb88c3609433e68f2eb81cbf407341f1a3715b70fb2f833a446975 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 4
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 4, $this->source); })()), "nombre", [], "any", false, false, false, 4), 'row');
        echo "
    ";
        // line 5
...
{{ form_end(form) }}
", "@FOSUser/Registration/register_content.html.twig", "C:\\Users\\JMPAZ\\Documents\\todolistapp\\templates\\bundles\\FOSUserBundle\\Registration\\register_content.html.twig");
    }
}
