...
class __TwigTemplate_8c82e9c5786f9845bcc1ffef962c7e4cd1b76283803b4a429fc24d4193dcb2c5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<?php echo \$view['form']->block(\$form, 'form_widget_simple', ['type' => isset(\$type) ? \$type : 'text']).\$view->escape(\$symbol) ?>
", "FrameworkBundle:Form:percent_widget.html.php", "C:\\Users\\JMPAZ\\Documents\\todolistapp\\vendor\\symfony\\framework-bundle/Resources/views/Form/percent_widget.html.php");
    }
}
