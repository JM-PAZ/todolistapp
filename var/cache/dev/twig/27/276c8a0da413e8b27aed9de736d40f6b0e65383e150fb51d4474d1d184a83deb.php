...
class __TwigTemplate_39ec76450b1943ded9bd3b8a07dcfb4be67672e7419441f53d193815edac829c extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "categoria/show.html.twig"));
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["categorium"]) || array_key_exists("categorium", $context) ? $context["categorium"] : (function () { throw new RuntimeError('Variable "categorium" does not exist.', 16, $this->source); })()), "name", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% block body %}
    ...
    <a href=\"{{ path('categoria_index') }}\">Volver</a>

    <a href=\"{{ path('categoria_edit', {'id': categorium.id}) }}\">Editar</a>

    {{ include('categoria/_delete_form.html.twig') }}
{% endblock %}
", "categoria/show.html.twig", "C:\\Users\\JMPAZ\\Documents\\todolistapp\\templates\\categoria\\show.html.twig");
    }
}
