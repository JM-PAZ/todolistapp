...
// Returns the private 'App\Repository\ActividadesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ActividadesRepository.php';

return $this->privates['App\\Repository\\ActividadesRepository'] = new \App\Repository\ActividadesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
